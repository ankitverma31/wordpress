                ...
                <div class="single-post nobottommargin">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="author-image">
                                <?php 
                                    echo get_avatar( $author_ID, 90, '', false, ['class'=> 'img-circle'] ); 
                                ?>
                            </div>
                    ...
                    <div class="related-posts clearfix">
                        <?php
                            ...
                            $rp_query = new WP_Query(['posts_per_page' => 2, 'post__not_in' => [$post->ID], 'cat' => !empty($categories) ? $categories[0]->term_id : null]);
